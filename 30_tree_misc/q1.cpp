...
/*
    ...
    Flatten the binary tree in place into a "linked list": every node's left
    child becomes null and its right child points to the next node in the
    tree's pre-order traversal.
*/
