...
// https://codeforces.com/group/4vcXCPx8NY/contest/716805/problem/F
// F. Buy & Sell Stock: Unlimited Transactions + Cooldown
...
int solve(vector<int>&prices,int index,int transactionType){
    ...
    if(transactionType == BUY){
        ...
        //on now 1 days as cooldown so parso kharidnege ab
